...
Для примера использования можете посмотреть файл `app/public/js/client-test.js` в котором реализованы все методы работы с сервисом.
...
`details` - для передачи в запросе опционально но ключ является зарезервированым словом в структуре, 
